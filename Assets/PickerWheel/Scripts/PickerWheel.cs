...
namespace EasyUI.PickerWheelUI {
   ...
   public class PickerWheel : MonoBehaviour {
      ...
      [Range(1, 20)] public int extraRotations = 10; // Extra rotations before stopping
      [Range(1, 20)] public float spinDuration = 5f; // Duration of the spin in seconds
      ...
      private Vector2 pieceMinSize = new Vector2(50f, 146f); // Adjust as needed for visibility
private Vector2 pieceMaxSize = new Vector2(144f, 213f); // Adjust as needed for visibility
private int piecesMin = 2;
private int piecesMax = 23;
...
float pieceHeight = Mathf.Lerp(pieceMinSize.y, pieceMaxSize.y, 1f - Mathf.InverseLerp(piecesMin, piecesMax, wheelPieces.Length));
    ...
    // Assuming you have a reference to your PopupController instance
